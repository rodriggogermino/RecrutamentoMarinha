<?php
// Espaço reservado para a lógica de envio de email de recuperação em PHP
// Exemplo: if ($_SERVER["REQUEST_METHOD"] == "POST") { $email = $_POST['email']; ... }
?>
<!DOCTYPE html>
<html lang="pt">
...
<head>
    ...
    <title>Recuperação da Palavra-passe | Marinha Recrutamento</title>
...
<body>
    ...
    <main>
        <div class="card">
            ...
            <p>Introduz o email que utilizavas para fazer login no portal do Recrutamento.</p>
            <p>Será enviado um link para esse email para efetuares o reset da tua password.</p>

            <!-- Encapsulado num formulário POST para processamento em servidor -->
            <form method="POST" action="recoverpassword.php">
                <div class="field-wrap">
                    <label for="email">Email de recuperação</label>
                    <input type="email" id="email" name="email" placeholder="exemplo@email.com" autocomplete="email" required />
                </div>

                <!-- Alterado para tipo submit para poder disparar o envio do formulário -->
                <button type="submit" class="btn-submit" id="btnEnviar">Enviar</button>
            </form>

            <div class="success-msg" id="successMsg">
                ✓ &nbsp;Link de recuperação enviado. Verifica a tua caixa de entrada.
            </div>
            ...
            <div id="logotiposRedes">
                <a href="https://www.facebook.com/@marinharecrutamento" target="_blank">
                    ...
                    <span id="facebookIconHover">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 1C13.4087 1 11.8826 1.63214 10.7574 2.75736C9.63214 3.88258 9 5.4087 9 7V9H7C6.44772 9 6 9.44772 6 10V14C6 14.5523 6.44772 15 7 15H9V22C9 22.5523 9.44772 23 10 23H14C14.5523 23 15 22.5523 15 22V15H17C17.4589 15 17.8589 14.6877 17.9701 14.2425L18.9701 10.2425C19.0448 9.94379 18.7882 9.38459C18.5987 9.14187 18.3079 9 18 9H15V7H18C18.5523 7 19 6.55228 19 6V2C19 1.44772 18.5523 1 18 1H15Z" fill="white" />
                        </svg>
                    </span>
                </a>
                <a href="https://www.instagram.com/marinharecrutamento" target="_blank">
                    <span id="instagramIcon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M17.5 5.5C16.9477 5.5 16.5 5.94772 16.5 6.5C16.5 7.05228 16.9477 7.5 17.5 7.5H17.51C18.0623 7.5 18.51 7.05228 18.51 6.5C18.51 5.94772 18.0623 5.5 17.51 5.5H17.5Z" fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1 7C1 3.68629 3.68629 1 7 1H17C20.3137 1 23 3.68629 23 7V17C23 20.3137 20.3137 23 17 23H7C3.68629 23 1 20.3137 1 17V7ZM7 3C4.79086 3 3 4.79086 3 7V17C3 19.2091 4.79086 21 7 21H17C19.2091 21 21 19.2091 21 17V7C21 4.79086 19.2091 3 17 3H7Z" fill="white" />
                        </svg>
                    </span>
                    <span id="instagramIconHover">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1 7C1 3.68629 3.68629 1 7 1H17C20.3137 1 23 3.68629 23 7V17C23 20.3137 20.3137 23 17 23H7C3.68629 23 1 20.3137 1 17V7ZM17.5 5.5C16.9477 5.5 16.5 5.94772 16.5 6.5C16.5 7.05228 16.9477 7.5 17.5 7.5H17.51C18.0623 7.5 18.51 7.05228 18.51 6.5C18.51 5.94772 18.0623 5.5 17.51 5.5H17.5ZM12.7767 7.01087C11.7364 6.85661 10.6739 7.0343 9.7404 7.51868C8.8069 8.00305 8.0499 8.76944 7.57707 9.70884C7.10425 10.6482 6.93967 11.7128 7.10675 12.7511C7.27383 13.7895 7.76406 14.7487 8.50771 15.4923C9.25137 16.236 10.2106 16.7262 11.2489 16.8933C12.2872 17.0604 13.3518 16.8958 14.2912 16.423C15.2306 15.9501 15.997 15.1931 16.4814 14.2596C16.9657 13.3261 17.1434 12.2637 16.9892 11.2234C16.8318 10.1622 16.3373 9.17981 15.5788 8.42126C14.8202 7.6627 13.8378 7.16823 12.7767 7.01087Z" fill="white" />
                        </svg>
                    </span>
                </a>
                ...
                <a href="https://www.linkedin.com/in/marinha-portuguesa" target="_blank">
                    <span id="linkedinIcon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4 1C2.34315 1 1 2.34315 1 4C1 5.65685 2.34315 7 4 7C5.65685 7 7 5.65685 7 4C7 2.34315 5.65685 1 4 1ZM3 4C3 3.44772 3.44772 3 4 3C4.55228 3 5 3.44772 5 4C5 4.55228 4.55228 5 4 5C3.44772 5 3 4.55228 3 4Z" fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0503 9.05025C12.363 7.7375 14.1435 7 16 7C17.8565 7 19.637 7.7375 20.9497 9.05025C22.2625 10.363 23 12.1435 23 14V21C23 21.5523 22.5523 22 22 22H18C17.4477 22 17 21.5523 17 21V14C17 13.7348 16.8946 13.4804 16.7071 13.2929C16.5196 13.1054 16.2652 13 16 13C15.7348 13 15.4804 13.1054 15.2929 13.2929C15.1054 13.4804 15 13.7348 15 14V21C15 21.5523 14.5523 22 14 22H10C9.44771 22 9 21.5523 9 21V14C9 12.1435 9.7375 10.363 11.0503 9.05025ZM16 9C14.6739 9 13.4021 9.52678 12.4645 10.4645C11.5268 11.4021 11 12.6739 11 14V20H13V14C13 13.2043 13.3161 12.4413 13.8787 11.8787C14.4413 11.3161 15.2043 11 16 11C16.7957 11 17.5587 11.3161 18.1213 11.8787C18.6839 12.4413 19 13.2043 19 14V20H21V14C21 12.6739 20.4732 11.4021 19.5355 10.4645C18.5979 9.52678 17.3261 9 16 9Z" fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1 9C1 8.44772 1.44772 8 2 8H6C6.55228 8 7 8.44772 7 9V21C7 21.5523 6.55228 22 6 22H2C1.44772 22 1 21.5523 1 21V9ZM3 10V20H5V10H3Z" fill="white" />
                        </svg>
                    </span>
                    <span id="linkedinIconHover">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 1C2.34315 1 1 2.34315 1 4C1 5.65685 2.34315 7 4 7C5.65685 7 7 5.65685 7 4C7 2.34315 5.65685 1 4 1Z" fill="white" />
                            <path d="M16 7C14.1435 7 12.363 7.7375 11.0503 9.05025C9.7375 10.363 9 12.1435 9 14V21C9 21.5523 9.44771 22 10 22H14C14.5523 22 15 21.5523 15 21V14C15 13.7348 15.1054 13.4804 15.2929 13.2929C15.4804 13.1054 15.7348 13 16 13C16.2652 13 16.5196 13.1054 16.7071 13.2929C16.8946 13.4804 17 13.7348 17 14V21C17 21.5523 17.4477 22 18 22H22C22.5523 22 23 21.5523 23 21V14C23 12.1435 22.2625 10.363 20.9497 9.05025C19.637 7.7375 17.8565 7 16 7Z" fill="white" />
                            <path d="M2 8C1.44772 8 1 8.44772 1 9V21C1 21.5523 1.44772 22 2 22H6C6.55228 22 7 21.5523 7 21V9C7 8.44772 6.55228 8 6 8H2Z" fill="white" />
                        </svg>
                    </span>
                </a>
            </div>
