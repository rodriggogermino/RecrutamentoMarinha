<?php
// Homepage convertida de HTML para PHP.
// (Não há lógica de backend nesta página neste momento.)
?>
...
<body>
    <nav>
        ...
        <a href="index.php" id="navLogoXS"><img src="Utilities/Images/logoWhiteXS.png" alt="Logotipo Branca | Marinha Portuguesa"></a>
    ...
    <main class="container">
        ...
        <!-- Ícones da linha 20 a 53 (menu do utilizador) agora por baixo da imagem -->
        <section class="hero-icons">
            <div class="hero-icons-grid">
                <a class="hero-icon" href="index.php" title="Início">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
                        <polyline points="9 22 9 12 15 12 15 22"/>
                    </svg>
                </a>
                <a class="hero-icon" href="perfil.html" title="Perfil">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/>
                        <circle cx="12" cy="7" r="4"/>
                    </svg>
                </a>
                <a class="hero-icon" href="mensagens.html" title="Mensagens">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect width="20" height="16" x="2" y="4" rx="2"/>
                        <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
                    </svg>
                </a>
                <a class="hero-icon" href="documentos.html" title="Documentos">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>
                    </svg>
                </a>
                <a class="hero-icon" href="candidaturas.html" title="Candidaturas">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a class="hero-icon" href="definicoes.html" title="Definições">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a class="hero-icon" href="inscricao.html" title="Candidata-te">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 20h9"/>
                        <path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/>
                    </svg>
                </a>
                <a class="hero-icon" href="seguranca.html" title="Alterar Palavra-Passe">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a class="hero-icon" href="estado.html" title="Estado da Candidatura">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a class="hero-icon" href="contactos.html" title="Contactos / Suporte">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                    </svg>
                </a>
                <a class="hero-icon" href="login.html" title="Terminar Sessão">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <section class="status-grid">
            <a class="status-card" href="documentos.html">
                <span>TENS 0 DOCUMENTOS PARA ENTREGAR</span>
                <i class="fa-solid fa-arrow-right"></i>
            </a>
            <a class="status-card" href="mensagens.html">
                <span>TENS 0 MENSAGENS PARA LER</span>
                <i class="fa-solid fa-arrow-right"></i>
            </a>
            <a class="status-card" href="candidaturas.html">
                <span>TENS 0 CANDIDATURAS SUBMETIDAS</span>
                <i class="fa-solid fa-arrow-right"></i>
            </a>
        </section>
        ...
        <section class="concursos">
            ...
            <div class="accordion-item">
                <div class="accordion-header" onclick="toggleAccordion(this)">
                    <p>Concurso de Admissão de Voluntários para Ingresso na Categoria de Praças da Classe de Músicos (B) dos Quadros Permanentes (QP) – Saxofone; Trompa de Harmonia; Trombone Tenor</p>
                    <i class="fa-solid fa-chevron-down accordion-arrow"></i>
                </div>
                <div class="accordion-body">
                    <p>Início das candidaturas:14/05/2026</p>
                    <p>Fim das candidaturas:31/07/2026</p>
                    <p>Incorporação:09/11/2026</p>

                    <div class="candidatar-me-row">
                        <a class="candidatarBtn" href="candidatar-me.html">candidatar-me</a>
                    </div>

                    <div class="incorporacao-row">
                        <a class="downloadLink" href="Utilities/Docs/aviso.pdf" download="aviso.pdf">
                            <span class="incorporacao-text">Diario da republica</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                <div class="accordion-header" onclick="toggleAccordion(this)">
                    <p>Concurso de Admissão de Voluntários para Prestação de Serviço em Regime de Contrato (RC) ou Regime de Voluntariado (RV) na categoria de Praças para a classe de Serviço Naval (SN) 2026 – 2.ª edição</p>
                    <i class="fa-solid fa-chevron-down accordion-arrow"></i>
                </div>
                <div class="accordion-body">
                    <p>Informação detalhada sobre este concurso.</p>
                </div>
            </div>
        </section>
