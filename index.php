...
<body>
    <div id="loader"><img src="Utilities/Images/logoWhiteS.png" alt="">
        <div class="barraLoader"></div>
    </div>
    <article class="scrollSnap">
        <!--#### NAVBAR ####-->
        <nav>
            <a href="index.html" id="navLogoS"><img src="Utilities/Images/logoWhiteS.png" alt="Logotipo Branco | Marinha Portuguesa"></a>
            <a href="index.html" id="navLogoXS"><img src="Utilities/Images/logoWhiteXS.png" alt="Logotipo Branco | Marinha Portuguesa"></a>
            <div id="rightNav">
                <form action="/">
            ...
            <div id="bottomHomepage">
                ...
                <div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.7071 18.7071C17.3166 19.0976 16.6834 19.0976 16.2929 18.7071L12 14.4142L7.7071 18.7071C7.3166 19.0976 6.6834 19.0976 6.2929 18.7071C5.9024 18.3166 5.9024 17.6834 6.2929 17.2929L11.2929 12.2929C11.6834 11.9024 12.3166 11.9024 12.7071 12.2929L17.7071 17.2929C18.0976 17.6834 18.0976 18.3166 17.7071 18.7071Z" fill="white"/>
                    </svg>
                    <p>Desliza para cima</p>
                </div>
            </div>
        </section>
        <!--#### SIDE BUTTONS ####-->
        ...
        <div id="chatbotDiv">
            ...
            <div id="chatbotPrompt">
                <p>*O Marujo pode conter erros. Considere verificar informações importantes.</p>
            ...
            <div id="destaquesContainer">
                ...
                <div id="destaquesSlideshow">
                    ...
                    <div class="buttonsSlides">
                        ...
                        <span class="btnNext" id="destaquesBtnNext" style="cursor: pointer;">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <!--#### SECTION 3 ####-->
        <section id="pesquisaCarreiraSection">
            <div id="pesquisaCarreiraContainer">
                <div id="pesquisaCarreiraLeft">
                    <p>Na Marinha podes ser <span>MILITAR</span> <br> <span>MILITARIZADO</span> ou <span>CIVIL</span>
                    </p>
                    <div id="pesquisaCarreiraLeftDropdown">
                        <div class="custom-dropdown">
                            <button class="dropdown-btn">Habilitações
                                <svg width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L4 4L7 1" stroke="#182439" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </button>
                            <ul class="dropdown-options">
                                <li class="option selected">Ensino Básico</li>
                                <li class="option">Ensino Secundário</li>
                                <li class="option">Ensino Superior</li>
                            </ul>
                        </div>
                        <div class="custom-dropdown">
                            <button class="dropdown-btn">Idade
                                <svg width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L4 4L7 1" stroke="#182439" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                            ...
                            <ul class="dropdown-options">
                                <li class="option selected">18</li>
                                ...
                                <li class="option">26</li>
                                <li class="option">27</li>
                                <li class="option">+27</li>
                            </ul>
                        </div>
                        <!--#### DROPDOWN BTN PESQUISA ####-->
                        <button class="searchDropdownBtn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.29289 5.29289C8.68342 4.90237 9.31658 4.90237 9.70711 5.29289L15.7071 11.2929C16.0976 11.6834 16.0976 12.3166 15.7071 12.7071L9.70711 18.7071C9.31658 19.0976 8.68342 19.0976 8.29289 18.7071C7.90237 18.3166 7.90237 17.6834 8.29289 17.2929L13.5858 12L8.29289 6.70711C7.90237 6.31658 7.90237 5.68342 8.29289 5.29289Z"
                ...
                <div id="pesquisaCarreiraRight">
                    <div id="pesquisaCarreiraRightContainer">
                        <img src="Utilities/Images/pesquisa1.png" id="imgPesquisaCarreira1" alt="Cívil">
                        <img src="Utilities/Images/pesquisa3.png" id="imgPesquisaCarreira3" alt="Militarizado">
                    </div>
                    <img src="Utilities/Images/pesquisa2.png" id="imgPesquisaCarreira2" alt="Militar">
                </div>
            </div>
        </section>
        <!--#### SECTION 4 ####-->
        <section id="ondeEstamosSection">
            <div id="ondeEstamosSectionContainer">
                <p>Estamos no <span>MAR</span>, em <span>TERRA</span>, no <span>AR</span> e no <span>CIBERESPAÇO</span></p>

                <div id="slideshowOndeEstamos">
                    <div id="cardsOndeEstamos">
                        <div class="cardOndeEstamos">
                ...
                <div class="buttonsSlides" id="buttonsOndeEstamos">
                    <span class="btnPrevious" id="btnPrevOnde" style="cursor: pointer;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M15.7071 5.29289C16.0976 5.68342 16.0976 6.31658 15.7071 6.70711L10.4142 12L15.7071 17.2929C16.0976 17.6834 16.0976 18.3166 15.7071 18.7071C15.3166 19.0976 14.6834 19.0976 14.2929 18.7071L8.29289 12.7071C7.90237 12.3166 7.90237 11.6834 8.29289 11.2929L14.2929 5.29289C14.6834 4.90237 15.3166 4.90237 15.7071 5.29289Z" fill="#182439" />
                </svg>
            </span>
                    <span class="btnNext" id="btnNextOnde" style="cursor: pointer;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 5.29289C8.68342 4.90237 9.31658 4.90237 9.70711 5.29289L15.7071 11.2929C16.0976 11.6834 16.0976 12.3166 15.7071 12.7071L9.70711 18.7071C9.31658 19.0976 8.68342 19.0976 8.29289 18.7071C7.90237 18.3166 7.90237 17.6834 8.29289 17.2929L13.5858 12L8.29289 6.70711C7.90237 6.31658 7.90237 5.68342 8.29289 5.29289Z" fill="#182439" />
                </svg>
            </span>
                </div>
            </div>
        ...
        <!--#### SECTION 5 ####-->
        <section id="testemunhosSection">
            <div id="testemunhosSectionContainer">
                <h1 class="titulo2" style="margin: 0;">TESTEMUNHOS</h1>
                <!--#### CARDS TESTEMUNHOS ####-->
                <div id="slideshowTestemunhos">
                    <div id="cardsTestemunhos">
                        <!--#### CARD ####-->
                        <figure class="figureTestemunhos">
                            <h3>Mulheres nas Forças Armadas</h3>
                            <p>
                                Sabias que a Convenção sobre a eliminação de Todas as Formas de Discriminação contra as Mulheres prevê, entre outros direitos, o direito à livre escolha da profissão e do emprego, o direito à promoção, à estabilidade do emprego e a todas as prestações
                                e condições de trabalho e o direito à formação profissional e à reciclagem, incluindo a aprendizagem, o aperfeiçoamento profissional e a formação permanente? Sim, vais poder encontrar tudo isto nas Forças Armadas Portuguesas!
                                A Marinha produziu este vídeo para enaltecer o trabalho realizado por mais de 1500 mulheres na organização e promover a igualdade de género.
                            </p>
                            <figcaption class="videoTestemunhoThumbFigure">
                                <a href="https://www.youtube.com/watch?v=c9NDgiP4CVA&list=PLc92VllkvmwL2VgEegpjyN90EZVbfj-rT&index=1" target="_blank">
                                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 21C0 9.40202 9.40202 0 21 0C32.598 0 42 9.40202 42 21C42 32.598 32.598 42 21 42C9.40202 42 0 32.598 0 21Z" fill="#33363A"/>
                                            <path d="M29 21.3333L16 13V29L29 21.3333Z" fill="#E9EAED" stroke="#E9EAED" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </a>
                                <img src="Utilities/Images/testemunhos1.jpg" alt="Mulheres no Mar | Testemunhos">
                            </figcaption>
                        </figure>
                        <!--#### CARD ####-->
                        <figure class="figureTestemunhos">
                            <h3>Marinha | Eletromecânico</h3>
                            <p>
                                Podes exercer funções no âmbito da execução e direção das operações de utilização, condução e manutenção das instalações propulsoras dos navios e respetivos auxiliares, dos equipamentos respeitantes à produção e distribuição de energia elétrica e de outros
                                sistemas e equipamentos associados. Vem descobrir o que a Marinha te pode proporcionar e concorre, clicando em "Junta-te a nós" na página de Recrutamento!
                            </p>
                            <figcaption class="videoTestemunhoThumbFigure">
                                <a href="https://www.youtube.com/watch?v=L2csOt9s4MI&list=PLc92VllkvmwL2VgEegpjyN90EZVbfj-rT&index=5" target="_blank">
                                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 21C0 9.40202 9.40202 0 21 0C32.598 0 42 9.40202 42 21C42 32.598 32.598 42 21 42C9.40202 42 0 32.598 0 21Z" fill="#33363A"/>
                                            <path d="M29 21.3333L16 13V29L29 21.3333Z" fill="#E9EAED" stroke="#E9EAED" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </a>
                                <img src="Utilities/Images/testemunho3.jpg" alt="Marinha | Eletromecânico | Testemunhos">
                            </figcaption>
                        </figure>
                        <!--#### CARD ####-->
                        <figure class="figureTestemunhos">
                            <h3>Marinha | Mergulhadores</h3>
                            <p>
                                O Segundo-Marinheiro Puga da Silva mergulhou no desafio, TU TAMBÉM PODES FAZÊ-LO! Tens entre 18 e 24 anos de idade e no mínimo o 9° ano de escolaridade? Vem descobrir o que a Marinha te pode proporcionar e concorre, clicando em "Junta-te a nós" na página
                                de Recrutamento!
                            </p>
                            <figcaption class="videoTestemunhoThumbFigure">
                                <a href="https://www.youtube.com/watch?v=bnC6lsjNTQs&list=PLc92VllkvmwL2VgEegpjyN90EZVbfj-rT&index=3" target="_blank">
                                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 21C0 9.40202 9.40202 0 21 0C32.598 0 42 9.40202 42 21C42 32.598 32.598 42 21 42C9.40202 42 0 32.598 0 21Z" fill="#33363A"/>
                                            <path d="M29 21.3333L16 13V29L29 21.3333Z" fill="#E9EAED" stroke="#E9EAED" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </a>
                                <img src="Utilities/Images/testemunho4.jpg" alt="Marinha | Mergulhadores | Testemunhos">
                            </figcaption>
                        </figure>
                        <!--#### CARD ####-->
                        <figure class="figureTestemunhos">
                            <h3>Marinha | Fuzileiros</h3>
                            <p>
                                Faz como o Segundo-Marinheiro André Candeias e aproveita a oportunidade! Tens entre 18 e 24 anos de idade e no mínimo o 9° ano de escolaridade? Vem descobrir o que a Marinha te pode proporcionar e concorre, clicando em "Junta-te a nós" na página de Recrutamento!
                            </p>
                            <figcaption class="videoTestemunhoThumbFigure">
                                <a href="https://www.youtube.com/watch?v=67M7tUzjm48&list=PLc92VllkvmwL2VgEegpjyN90EZVbfj-rT&index=4" target="_blank">
                                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 21C0 9.40202 9.40202 0 21 0C32.598 0 42 9.40202 42 21C42 32.598 32.598 42 21 42C9.40202 42 0 32.598 0 21Z" fill="#33363A"/>
                                            <path d="M29 21.3333L16 13V29L29 21.3333Z" fill="#E9EAED" stroke="#E9EAED" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                </a>
                                <img src="Utilities/Images/testemunho2.jpg" alt="Marinha | Fuzileiros | Testemunhos">
                            </figcaption>
                        </figure>
                    </div>
                </div>
                <div class="buttonsSlides" id="btnSlidesTestemunhos" style="gap: 1vh;">
        ...
        <section id="footerSection">
            <h1 class="titulo1">JUNTA-TE A NÓS</h1>
            <img id="fuzileiroFooter" src="Utilities/Images/fuzileiroHomepage.png" alt="Fuzileiro da Marinha Portuguesa">
            <!--#### FOOTER ####-->
            <footer>
                <div id="topFooter">
                            ...
                            <span id="xIcon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="white" mask="url(#path-1-inside-1_707_1928)" />
                                </svg>
                            </span>
                        </a>
