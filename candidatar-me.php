...
<head>
  ...
  <title>Candidatar-me | Marinha Portuguesa</title>
  <link rel="stylesheet" href="login.css" />
  <link rel="stylesheet" href="homepage.css" />
  <link rel="stylesheet" href="candidatar-me.css" />
    ...
    <section class="cand-form-shell">
      ...
      <form class="cand-form" action="candidatura.php" method="POST">
        <div class="cand-tabs" role="tablist">
          ...
          <button type="button" class="tab" role="tab" aria-selected="false" data-index="1">
            <span class="tab-num">2</span><span class="tab-label">Morada</span>
          </button>
          <button type="button" class="tab" role="tab" aria-selected="false" data-index="2">
            <span class="tab-num">3</span><span class="tab-label">Filiação</span>
          </button>
          <button type="button" class="tab" role="tab" aria-selected="false" data-index="3">
            <span class="tab-num">4</span><span class="tab-label">Habilitações</span>
          </button>
          <button type="button" class="tab" role="tab" aria-selected="false" data-index="4">
            <span class="tab-num">5</span><span class="tab-label">Situação Militar</span>
          </button>
          <button type="submit" class="tab tab-finalizar" role="tab" aria-selected="false" data-index="5" id="btnSubmit">
        ...
        <div class="cand-panels">
          ...
          <div class="panel active" role="tabpanel">
            ...
            <div class="grid grid-3">
              ...
              <div class="fdInput fdFilled">
                <input id="telemovel" name="telemovel" type="tel" placeholder=" " value="934357397" required />
          ...
          <div class="panel" role="tabpanel">
            ...
            <div class="grid grid-2">
              <div class="fdInput"><input id="filhoDe" name="filhoDe" type="text" placeholder="Filho de*" /></div>
          ...
          <div class="panel" role="tabpanel">
            <div class="dashed-box">
              ...
              <div class="grid grid-2">
                <div class="fdSelect">
                  <select id="habilitacoes" name="habilitacoes">
                    <option>CURSO TECNOLÓGICO/PROFISSIONAL/OUTROS (NÍVEL V)</option>
                ...
                <div class="fdInput"><input id="escola" name="escola" type="text" placeholder="Escola/Universidade*" /></div>
              ...
              <div class="grid grid-2">
                <div class="fdSelect">
                  <select id="areaEducacao" name="areaEducacao">
                    <option>Grande Grupo</option>
          ...
          <div class="panel" role="tabpanel">
            <div class="mil-question">
              <span>Prestas ou prestaste serviço nalgum ramo das Forças Armadas?*</span>
              <select id="prestouServico" name="prestouServico" class="mil-select">
                <option>Sim</option>
                <option>Não</option>
              </select>
            </div>
          ...
          <div class="panel" role="tabpanel">
            ...
            <button type="submit" class="btn-teal btn-finalizar-submit">GRAVAR CANDIDATURA</button>
          </div>
        </div>
      </form>
    </section>
